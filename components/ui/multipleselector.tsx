            ...
            >
                <div
                    className={cn(
                        ...
                        {
                            'px-3 py-2 text-white': selected.length !== 0,
                            'cursor-text border-green-500': !disabled && selected.length !== 0,
                        },
                        className,
                    )}
                    onClick={() => {
                            ...
                            return (
                                <Badge
                                    ...
                                    className={cn(
                                        ...
                                        'data-[fixed]:bg-muted-foreground bg-red-700 data-[fixed]:text-muted data-[fixed]:hover:bg-muted-foreground',
                                        badgeClassName,
                                    )}
